...
def __save_undistorted_example_camera_calibration_images(fname, mtx, dist):
...
def save_example_camera_calibration_images(mtx, dist):
	...
	"""
	__save_undistorted_example_camera_calibration_images('./camera_cal/calibration8.jpg', mtx, dist)
	return mtx, dist
